...
const Enrolled_employees = () => {
    ...
    const fetchReport = async () => {
        ...
        try {
            ...
            const res = await axios.get(`${backendurl}/api/Report/doors`, {
            ...
            <Header currentPage="doors">
                ...
                <div style={styles.pageHeader}>
                    <div style={styles.pageHeaderLeft}>
                        ...
                        <div>
                            <h2 style={styles.pageTitle}>Biostar Door list</h2>
                            <p style={styles.pageSubtitle}>View the list of Doors</p>
                        </div>
                    </div>
