...
import { FileText, Users as UsersIcon, Calendar, Search, Download, RefreshCw, ChevronDown, Clock, LogIn, LogOut } from 'lucide-react'
...
const Tracking_emp_report = () => {
    ...
    const fetchReport = async () => {
        ...
        try {
            ...
            const res = await axios.post(`${backendurl}/api/Report/firstin-lastout-device`, payload, {
    ...
    return (
        <div className="app">
            <Header currentPage="tracking-emp-report">
                {/* Page Header */}
                <div style={styles.pageHeader}>
                    <div style={styles.pageHeaderLeft}>
                        ...
                        <div>
                            <h2 style={styles.pageTitle}>Employee Tracking Reports</h2>
...
export default Tracking_emp_report
