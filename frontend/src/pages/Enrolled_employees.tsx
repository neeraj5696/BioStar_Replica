...
const Enrolled_employees = () => {
    ...
    return (
        <div className="app">
            <Header currentPage="enrolled_employees">
                {/* Page Header */}
                <div style={styles.pageHeader}>
                    <div style={styles.pageHeaderLeft}>
                        ...
                        <div>
                            <h2 style={styles.pageTitle}>Enrolled Employees</h2>
                            <p style={styles.pageSubtitle}>View the list of enrolled employees in the Organization</p>
                        </div>
                    </div>
