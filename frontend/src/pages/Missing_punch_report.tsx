...
const Missing_punch_report = () => {
    ...
    const fetchReport = async () => {
        ...
        try {
            ...
            const res = await axios.post(`${backendurl}/api/Report/missing-punch-report`, payload, {
    ...
    return (
        <div className="app">
            <Header currentPage="missing_punches">
                {/* Page Header */}
                <div style={styles.pageHeader}>
                    <div style={styles.pageHeaderLeft}>
                        ...
                        <div>
                            <h2 style={styles.pageTitle}>Missing Punches Reports</h2>
...
export default Missing_punch_report
