...
const Shiftwise_report = () => {
    ...
    const fetchReport = async () => {
        ...
        try {
            ...
            const res = await axios.post(`${backendurl}/api/Report/shiftwise-report`, payload, {
            ...
            <Header currentPage="shiftwise">
                ...
                <div style={styles.pageHeader}>
                    <div style={styles.pageHeaderLeft}>
                        ...
                        <div>
                            <h2 style={styles.pageTitle}>Shift Reports</h2>
                            <p style={styles.pageSubtitle}>Track employee Shift entry and exit times across departments</p>
                        </div>
                    </div>
...
export default Shiftwise_report
